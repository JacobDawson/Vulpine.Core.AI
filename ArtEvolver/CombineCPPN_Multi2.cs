...
namespace ArtEvolver
{
    ...
    /// to another image.
    /// </summary>
    public class CombCPPN_Multi2 : Genetic<CombCPPN_Multi2>, Texture
    {
        ...
        public CombCPPN_Multi2(int num_tex)
        {
            ...
            n1 = sn + (2 * num_tex);  //2 + sn + PassThrough;
            n2 = 3 + PassThrough;
        ...
        public CombCPPN_Multi2(int num_tex, String nf1, String nf2, String nf3)
        {
            textures = new Texture[num_tex];
            for (int i = 0; i < textures.Length; i++)
                textures[i] = null;
        ...
        internal CombCPPN_Multi2(Texture tex, NetworkAuto net1, NetworkAuto net2)
        {          
            this.net1 = net1;
            this.net2 = net2;
            texture = tex;
        ...
        public Color SampleMain(double u, double v)
        {
            ...
            for (int i = 0; i < samples.Length; i++)
            {
                ...
                {
                    int k = i * 2;
                    double xq = out1[k + 0] * SF;
                    double yq = out1[k + 1] * SF;

                    //samples the texture
                    samples[i] = textures[i].Sample(xq, yq);
                }
            }
        ...
        public void Overwrite(CombCPPN_Multi2 genome)
        {
        ...
        public void Crossover(VRandom rng, CombCPPN_Multi2 genome)
        {
            net1.Crossover(rng, genome.net1);
            net2.Crossover(rng, genome.net2);
        }

        public double Compare(CombCPPN_Multi2 genome)
        {
        ...
        public void Lerp(CombCPPN_Multi2 genome, double amount)
        {
            net1.Lerp(genome.net1, amount);
            net2.Lerp(genome.net2, amount);
        }

        public void Lerp(CombCPPN_Multi2 start, CombCPPN_Multi2 target, double amount)
        {
        ...
        public CombCPPN_Multi2 Clone()
        {
            ...
            return new CombCPPN_Multi2(texture, c1, c2);
        }
